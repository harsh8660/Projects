...
<?php 
    ...
    $sql="SELECT * FROM $TableName WHERE Gender='MALE'";
    ...
    echo "
        <div class=\"product_col\">
            <form method=\"POST\" action=\"BuyProduct.php\">
                ...
                <button name=\"Submit\" type=\"submit\"class=\"btn btn-danger\" style=\"margin-left:20px;width:110px;margin-right:3px;\" >Buy Now</button>
            </form>
        </div>";
    }
?>
